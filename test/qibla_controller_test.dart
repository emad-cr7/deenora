...
void main() {
  group('QiblaController Tests', () {
    ...
    test(
      'Angular difference correctly handles 0/360 degree boundary wrap-around',
      () {
    ...
    test(
      'User Example 1: Bearing 136, Heading 134 -> diff 2 deg, facing Qibla',
      () {
        double qiblah = 136.0;
    ...
    test(
      'User Example 2: Bearing 136, Heading 150 -> diff 14 deg, NOT facing Qibla (turn left 14 deg)',
      () {
        double qiblah = 136.0;
    ...
    test(
      'User Example 3: Qibla 359, Heading 1 -> 2 deg apart, facing Qibla',
      () {
        double qiblah = 359.0;
        double heading = 1.0;
        double diff = (qiblah - heading) % 360.0;
    ...
    test(
      'User Example 4: Qibla 1, Heading 359 -> 2 deg apart, facing Qibla',
      () {
        double qiblah = 1.0;
        double heading = 359.0;
        double diff = (qiblah - heading) % 360.0;
    ...
    test(
      'Real QiblahDirection simulation: using data.offset triggers alignment correctly',
      () {
